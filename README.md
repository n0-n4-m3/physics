...
$$P_\text{тела в жидкости} = P_\text{тела в воздухе}(1-\frac{\rho_\text{жидкости}}{\rho_\text{тела}})$$
...
**Решение**
<p align="center"><img src="./hydrostatic1.jpg" style="width: 30%;"></img></p>
...
$$V_{над водой} = V_{кочана} - \frac{m_к}{\rho}= 0,01 - 0,008 = 0,002м^3  = 2л$$
...
$$p = p_0 + \rho gh$$
$$p = 100 * 10^3 + 10^3*10*5 = 150*10^3 Па = 150 кПа$$
